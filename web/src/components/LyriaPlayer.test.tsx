...
vi.mock('../hooks/useOrchestrator', () => ({
  useOrchestrator: vi.fn(() => ({
    ...
    settings: { masterVolume: 0.5, descriptionEnabled: true, analysisEnabled: true, intentionEnabled: true, musicEnabled: true, sfxEnabled: true, ttsRate: 1.0, screenReaderMode: false },
