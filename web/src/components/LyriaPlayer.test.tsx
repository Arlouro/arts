...
vi.mock('../hooks/useOrchestrator', () => ({
  useOrchestrator: vi.fn(() => ({
    ...
    setIsUiAnnouncing: vi.fn(),
    settings: { masterVolume: 0.5, descriptionEnabled: true, analysisEnabled: true, intentionEnabled: true, musicEnabled: true, sfxEnabled: true, ttsRate: 1.0, screenReaderMode: false, earconsEnabled: false, hapticsEnabled: false, centeringBeaconEnabled: false, framingVoiceEnabled: true, processingBedEnabled: false, autoNarrate: false },
    ...
    silenceAllAudio: vi.fn(() => Promise.resolve()),
    waitForSystemVoice: vi.fn(() => Promise.resolve()),
